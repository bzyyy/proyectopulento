...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Enviar solicitud POST al backend para autenticación
      ...
      if (token) {
        // Autenticación exitosa, realizar acciones adicionales
          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <p className="text-sm font-light text-gray-500 dark:text-gray-400">
               ¿No tienes cuenta?, 
               <a href="/register" className="font-medium text-primary-600 hover:underline dark:text-primary-500"> Regístrate </a>
              </p>
            </form>
          </div>
        </div>
